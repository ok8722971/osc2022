...
int sd_mount() {
    ...
    if (p1.partition_type == 0x0b) {  // FAT32 with CHS addressing
		...
		uart_printf_sync("n_fat:%d, sector_per_fat:%d, first_cluster:%d, sector_per_cluster:%d\n", fat32_metadata.n_fat, fat32_metadata.sector_per_fat, fat32_metadata.first_cluster, fat32_metadata.sector_per_cluster);
